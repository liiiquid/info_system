...
QT_MOC_LITERAL(4, 29, 10), // "close_self"
QT_MOC_LITERAL(5, 40, 5), // "event"
QT_MOC_LITERAL(6, 46, 7) // "QEvent*"

    },
    "t_socket\0write_out\0\0message*\0close_self\0"
    "event\0QEvent*"
};
...
void t_socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->close_self(); break;
        case 2: { bool _r = _t->event((*reinterpret_cast< QEvent*(*)>(_a[1])));
