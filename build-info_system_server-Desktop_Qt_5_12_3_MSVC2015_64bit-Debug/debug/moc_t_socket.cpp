...
#include "../../info_system_server/m_network/t_socket.h"
...
QT_MOC_LITERAL(1, 9, 6), // "readok"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 12), // "socket_close"
QT_MOC_LITERAL(4, 30, 4), // "read"
QT_MOC_LITERAL(5, 35, 13), // "write_process"
QT_MOC_LITERAL(6, 49, 12) // "close_socket"

    },
    "t_socket\0readok\0\0socket_close\0read\0"
    "write_process\0close_socket"
};
...
void t_socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->socket_close(); break;
        case 2: _t->read(); break;
        case 3: _t->write_process(); break;
        case 4: _t->close_socket(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (t_socket::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&t_socket::readok)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (t_socket::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&t_socket::socket_close)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void t_socket::readok()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void t_socket::socket_close()
{
