...
#include "../../info_system_server/ui_class/mbutton.h"
...
QT_MOC_LITERAL(1, 8, 12), // "mbtn_clicked"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "MButton\0mbtn_clicked\0"
};
...
void MButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mbtn_clicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MButton::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MButton::mbtn_clicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MButton::staticMetaObject = { {
    &QPushButton::staticMetaObject,
    qt_meta_stringdata_MButton.data,
...
// SIGNAL 0
void MButton::mbtn_clicked(int _t1)
{
